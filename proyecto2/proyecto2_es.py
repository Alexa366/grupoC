...
import pickle
import pandas as pd
from proyecto2.ml import modelo_filtrado
...
def proyecto2es():
    ...
    with col3:
        ...
        if prediccion == ():
            ...
            col3.write(modelo_filtrado(prediccion)[2])
            col3.write(modelo_filtrado(prediccion)[3])
            col3.write(modelo_filtrado(prediccion)[4])
